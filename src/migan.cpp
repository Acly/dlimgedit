...
Tensor lrelu_agc(ModelRef m, Tensor x, float alpha, float gain, float clamp) {
...
std::pair<Tensor, Tensor> encoder_block(ModelRef m, Tensor x, conv flag) {
...
MIGANParams MIGANParams::detect(ModelRef m) {
